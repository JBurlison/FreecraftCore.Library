...
namespace FreecraftCore
{
	...
	public sealed partial class MSG_MOVE_HEARTBEAT_Payload : GamePacketPayload, IPlayerMovementPayload<MovementInfo, MovementFlag, PackedGuid>
	{
		...
		public MSG_MOVE_HEARTBEAT_Payload()
