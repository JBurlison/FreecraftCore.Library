...
namespace FreecraftCore
{
	...
	public sealed partial class MSG_MOVE_START_STRAFE_RIGHT_Payload : GamePacketPayload, IPlayerMovementPayload<MovementInfo, MovementFlag, PackedGuid>
	{
		...
		public MSG_MOVE_START_STRAFE_RIGHT_Payload([NotNull] PackedGuid movementGuid, [NotNull] MovementInfo moveInfo)
			: this()
		{
		...
		public MSG_MOVE_START_STRAFE_RIGHT_Payload()
			: base(NetworkOperationCode.MSG_MOVE_START_STRAFE_RIGHT)
		{
