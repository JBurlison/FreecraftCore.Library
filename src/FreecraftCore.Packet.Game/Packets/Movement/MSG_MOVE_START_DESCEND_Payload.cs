...
namespace FreecraftCore
{
	...
	public sealed partial class MSG_MOVE_START_DESCEND_Payload : GamePacketPayload, IPlayerMovementPayload<MovementInfo, MovementFlag, PackedGuid>
	{
		...
		public MSG_MOVE_START_DESCEND_Payload([NotNull] PackedGuid movementGuid, [NotNull] MovementInfo moveInfo)
			: this()
		{
		...
		protected MSG_MOVE_START_DESCEND_Payload()
			: base(NetworkOperationCode.MSG_MOVE_START_DESCEND)
		{
