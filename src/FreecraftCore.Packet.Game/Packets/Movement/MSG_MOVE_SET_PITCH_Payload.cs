...
namespace FreecraftCore
{
	...
	public sealed partial class MSG_MOVE_SET_PITCH_Payload : GamePacketPayload, IPlayerMovementPayload<MovementInfo, MovementFlag, PackedGuid>
	{
		...
		public MSG_MOVE_SET_PITCH_Payload([NotNull] PackedGuid movementGuid, [NotNull] MovementInfo moveInfo)
			: this()
		{
		...
		public MSG_MOVE_SET_PITCH_Payload()
			: base(NetworkOperationCode.MSG_MOVE_SET_PITCH)
		{
