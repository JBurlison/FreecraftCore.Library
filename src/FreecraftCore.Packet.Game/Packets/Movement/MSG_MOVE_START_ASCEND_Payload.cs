...
namespace FreecraftCore
{
	...
	public sealed class MSG_MOVE_START_ASCEND_Payload : GamePacketPayload, IPlayerMovementPayload<PlayerMoveInfo, MovementFlag>
	{
		/// <summary>
		...
		public MSG_MOVE_START_ASCEND_Payload([NotNull] PlayerMoveInfo moveInfo)
		{
