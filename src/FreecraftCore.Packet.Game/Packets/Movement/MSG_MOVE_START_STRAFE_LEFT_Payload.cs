...
namespace FreecraftCore
{
	...
	public sealed class MSG_MOVE_START_STRAFE_LEFT_Payload : GamePacketPayload, IPlayerMovementPayload<PlayerMoveInfo, MovementFlag>
	{
		/// <summary>
		...
		public MSG_MOVE_START_STRAFE_LEFT_Payload([NotNull] PlayerMoveInfo moveInfo)
		{
