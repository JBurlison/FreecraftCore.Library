...
namespace FreecraftCore
{
	...
	public sealed partial class MSG_MOVE_SET_TURN_RATE_Payload : GamePacketPayload, IMovementSpeedChangeOtherPayload
	{
		/// <inheritdoc />
		[WireMember(1)]
		...
		/// </summary>
		public MSG_MOVE_SET_TURN_RATE_Payload()
			: base(NetworkOperationCode.MSG_MOVE_SET_TURN_RATE)
		{
