...
namespace FreecraftCore
{
	...
	public sealed partial class SMSG_SPLINE_SET_SWIM_SPEED_Payload : GamePacketPayload, IMovementSpeedChangePayload
	{
		/// <inheritdoc />
		[WireMember(1)]
		...
		/// </summary>
		public SMSG_SPLINE_SET_SWIM_SPEED_Payload()
			: base(NetworkOperationCode.SMSG_SPLINE_SET_SWIM_SPEED)
		{
