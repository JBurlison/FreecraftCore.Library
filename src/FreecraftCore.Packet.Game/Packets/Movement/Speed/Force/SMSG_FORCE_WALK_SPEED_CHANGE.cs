...
namespace FreecraftCore
{
	...
	public sealed partial class SMSG_FORCE_WALK_SPEED_CHANGE_Payload : GamePacketPayload, IMovementSpeedChangePayload
	{
		[WireMember(1)]
		...
		/// </summary>
		public SMSG_FORCE_WALK_SPEED_CHANGE_Payload()
			: base(NetworkOperationCode.SMSG_FORCE_WALK_SPEED_CHANGE)
		{
