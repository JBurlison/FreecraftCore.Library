...
namespace FreecraftCore
{
    ...
    public partial class SMSG_NEW_WORLD_Payload
    {
        public override Type SerializableType => typeof(SMSG_NEW_WORLD_Payload);
        public override GamePacketPayload Read(Span<byte> buffer, ref int offset)
        {
            SMSG_NEW_WORLD_Payload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(GamePacketPayload value, Span<byte> buffer, ref int offset)
        {
            SMSG_NEW_WORLD_Payload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// code for the Type: <see cref="SMSG_NEW_WORLD_Payload"/>
    /// </summary>
    public sealed partial class SMSG_NEW_WORLD_Payload_AutoGeneratedTemplateSerializerStrategy
        : BaseAutoGeneratedSerializerStrategy<SMSG_NEW_WORLD_Payload_AutoGeneratedTemplateSerializerStrategy, SMSG_NEW_WORLD_Payload>
    {
        /// <summary>
        ...
        public override void InternalRead(SMSG_NEW_WORLD_Payload value, Span<byte> buffer, ref int offset)
        {
        ...
        /// <param name="buffer">See external doc.</param>
        /// <param name="offset">See external doc.</param>
        public override void InternalWrite(SMSG_NEW_WORLD_Payload value, Span<byte> buffer, ref int offset)
        {
            //Type: GamePacketPayload Field: 1 Name: OperationCode Type: NetworkOperationCode;
