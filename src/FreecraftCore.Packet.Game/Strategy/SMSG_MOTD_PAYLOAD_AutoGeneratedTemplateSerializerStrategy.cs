...
namespace FreecraftCore
{
    ...
    public partial class SMSG_MOTD_PAYLOAD
    {
        public override Type SerializableType => typeof(SMSG_MOTD_PAYLOAD);
        public override GamePacketPayload Read(Span<byte> buffer, ref int offset)
        {
            SMSG_MOTD_PAYLOAD_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(GamePacketPayload value, Span<byte> buffer, ref int offset)
        {
            SMSG_MOTD_PAYLOAD_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// code for the Type: <see cref="SMSG_MOTD_PAYLOAD"/>
    /// </summary>
    public sealed partial class SMSG_MOTD_PAYLOAD_AutoGeneratedTemplateSerializerStrategy
        : BaseAutoGeneratedSerializerStrategy<SMSG_MOTD_PAYLOAD_AutoGeneratedTemplateSerializerStrategy, SMSG_MOTD_PAYLOAD>
    {
        /// <summary>
        ...
        public override void InternalRead(SMSG_MOTD_PAYLOAD value, Span<byte> buffer, ref int offset)
        {
        ...
        /// <param name="buffer">See external doc.</param>
        /// <param name="offset">See external doc.</param>
        public override void InternalWrite(SMSG_MOTD_PAYLOAD value, Span<byte> buffer, ref int offset)
        {
            //Type: GamePacketPayload Field: 1 Name: OperationCode Type: NetworkOperationCode;
