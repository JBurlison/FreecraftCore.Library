...
namespace FreecraftCore.Serializer
{
    ...
    /// code for the Type: <see cref="Flags96<UInt32>"/>
    /// </summary>
    public sealed partial class Flags96_UInt32_AutoGeneratedTemplateSerializerStrategy
        : BaseAutoGeneratedSerializerStrategy<Flags96_UInt32_AutoGeneratedTemplateSerializerStrategy, Flags96<UInt32>>
    {
        /// <summary>
        ...
        public override void InternalRead(Flags96<UInt32> value, Span<byte> buffer, ref int offset)
        {
            //Type: Flags96 Field: 1 Name: One Type: UInt32;
            value.One = GenericTypePrimitiveSerializerStrategy<UInt32>.Instance.Read(buffer, ref offset);
            //Type: Flags96 Field: 2 Name: Two Type: UInt32;
            value.Two = GenericTypePrimitiveSerializerStrategy<UInt32>.Instance.Read(buffer, ref offset);
            //Type: Flags96 Field: 3 Name: Three Type: UInt32;
        ...
        /// <param name="buffer">See external doc.</param>
        /// <param name="offset">See external doc.</param>
        public override void InternalWrite(Flags96<UInt32> value, Span<byte> buffer, ref int offset)
        {
            //Type: Flags96 Field: 1 Name: One Type: UInt32;
