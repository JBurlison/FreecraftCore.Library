...
namespace FreecraftCore.Serializer
{
    ...
    /// code for the Type: <see cref="GenericStaticallySizedArrayChunkSeven<Int32>"/>
    /// </summary>
    public sealed partial class GenericStaticallySizedArrayChunkSeven_Int32_AutoGeneratedTemplateSerializerStrategy
        : BaseAutoGeneratedSerializerStrategy<GenericStaticallySizedArrayChunkSeven_Int32_AutoGeneratedTemplateSerializerStrategy, GenericStaticallySizedArrayChunkSeven<Int32>>
    {
        /// <summary>
        ...
        public override void InternalRead(GenericStaticallySizedArrayChunkSeven<Int32> value, Span<byte> buffer, ref int offset)
        {
            //Type: GenericStaticallySizedArrayChunkSeven Field: 1 Name: One Type: Int32;
            value.One = GenericTypePrimitiveSerializerStrategy<Int32>.Instance.Read(buffer, ref offset);
            //Type: GenericStaticallySizedArrayChunkSeven Field: 2 Name: Two Type: Int32;
            value.Two = GenericTypePrimitiveSerializerStrategy<Int32>.Instance.Read(buffer, ref offset);
            //Type: GenericStaticallySizedArrayChunkSeven Field: 3 Name: Three Type: Int32;
            value.Three = GenericTypePrimitiveSerializerStrategy<Int32>.Instance.Read(buffer, ref offset);
            //Type: GenericStaticallySizedArrayChunkSeven Field: 4 Name: Four Type: Int32;
            value.Four = GenericTypePrimitiveSerializerStrategy<Int32>.Instance.Read(buffer, ref offset);
            //Type: GenericStaticallySizedArrayChunkSeven Field: 5 Name: Five Type: Int32;
            value.Five = GenericTypePrimitiveSerializerStrategy<Int32>.Instance.Read(buffer, ref offset);
            //Type: GenericStaticallySizedArrayChunkSeven Field: 6 Name: Six Type: Int32;
            value.Six = GenericTypePrimitiveSerializerStrategy<Int32>.Instance.Read(buffer, ref offset);
            //Type: GenericStaticallySizedArrayChunkSeven Field: 7 Name: Seven Type: Int32;
        ...
        /// <param name="buffer">See external doc.</param>
        /// <param name="offset">See external doc.</param>
        public override void InternalWrite(GenericStaticallySizedArrayChunkSeven<Int32> value, Span<byte> buffer, ref int offset)
        {
            //Type: GenericStaticallySizedArrayChunkSeven Field: 1 Name: One Type: Int32;
