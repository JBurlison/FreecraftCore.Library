...
namespace FreecraftCore.Serializer
{
    ...
    /// code for the Type: <see cref="GenericStaticallySizedArrayChunkThree<Int32>"/>
    /// </summary>
    public sealed partial class GenericStaticallySizedArrayChunkThree_Int32_AutoGeneratedTemplateSerializerStrategy
        : BaseAutoGeneratedSerializerStrategy<GenericStaticallySizedArrayChunkThree_Int32_AutoGeneratedTemplateSerializerStrategy, GenericStaticallySizedArrayChunkThree<Int32>>
    {
        /// <summary>
        ...
        /// <param name="buffer">See external doc.</param>
        /// <param name="offset">See external doc.</param>
        public override void InternalWrite(GenericStaticallySizedArrayChunkThree<Int32> value, Span<byte> buffer, ref int offset)
        {
            //Type: GenericStaticallySizedArrayChunkThree Field: 1 Name: One Type: Int32;
