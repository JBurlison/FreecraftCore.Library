...
namespace FreecraftCore
{
    ...
    public partial class TempLocationStructure : IWireMessage<TempLocationStructure>
    {
        public virtual Type SerializableType => typeof(TempLocationStructure);
        public virtual TempLocationStructure Read(Span<byte> buffer, ref int offset)
        {
            TempLocationStructure_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public virtual void Write(TempLocationStructure value, Span<byte> buffer, ref int offset)
        {
            TempLocationStructure_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
