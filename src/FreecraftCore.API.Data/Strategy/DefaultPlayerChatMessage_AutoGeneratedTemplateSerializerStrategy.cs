...
namespace FreecraftCore
{
    ...
    public partial class DefaultPlayerChatMessage
    {
        public override Type SerializableType => typeof(DefaultPlayerChatMessage);
        public override PlayerChatMessage Read(Span<byte> buffer, ref int offset)
        {
            DefaultPlayerChatMessage_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(PlayerChatMessage value, Span<byte> buffer, ref int offset)
        {
            DefaultPlayerChatMessage_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// code for the Type: <see cref="DefaultPlayerChatMessage"/>
    /// </summary>
    public sealed partial class DefaultPlayerChatMessage_AutoGeneratedTemplateSerializerStrategy
        : BaseAutoGeneratedSerializerStrategy<DefaultPlayerChatMessage_AutoGeneratedTemplateSerializerStrategy, DefaultPlayerChatMessage>
    {
        /// <summary>
        ...
        public override void InternalRead(DefaultPlayerChatMessage value, Span<byte> buffer, ref int offset)
        {
            ...
            //Type: DefaultPlayerChatMessage Field: 1 Name: Message Type: String;
        ...
        /// <param name="buffer">See external doc.</param>
        /// <param name="offset">See external doc.</param>
        public override void InternalWrite(DefaultPlayerChatMessage value, Span<byte> buffer, ref int offset)
        {
            //Type: PlayerChatMessage Field: 1 Name: MessageType Type: ChatMessageType;
