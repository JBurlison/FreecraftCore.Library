...
namespace FreecraftCore.Serializer
{
    ...
    /// code for the Type: <see cref="SpellEntry<StringDBCReference>"/>
    /// </summary>
    public sealed partial class SpellEntry_StringDBCReference_AutoGeneratedTemplateSerializerStrategy
        : BaseAutoGeneratedSerializerStrategy<SpellEntry_StringDBCReference_AutoGeneratedTemplateSerializerStrategy, SpellEntry<StringDBCReference>>
    {
        /// <summary>
        ...
        public override void InternalRead(SpellEntry<StringDBCReference> value, Span<byte> buffer, ref int offset)
        {
            ...
            value.SpellName = LocalizedStringDBC_StringDBCReference_AutoGeneratedTemplateSerializerStrategy.Instance.Read(buffer, ref offset);
            //Type: SpellEntry Field: 81 Name: Rank Type: LocalizedStringDBC;
            value.Rank = LocalizedStringDBC_StringDBCReference_AutoGeneratedTemplateSerializerStrategy.Instance.Read(buffer, ref offset);
            //Type: SpellEntry Field: 83 Name: Description Type: LocalizedStringDBC;
            value.Description = LocalizedStringDBC_StringDBCReference_AutoGeneratedTemplateSerializerStrategy.Instance.Read(buffer, ref offset);
            //Type: SpellEntry Field: 85 Name: ToolTip Type: LocalizedStringDBC;
            value.ToolTip = LocalizedStringDBC_StringDBCReference_AutoGeneratedTemplateSerializerStrategy.Instance.Read(buffer, ref offset);
        ...
        /// <param name="buffer">See external doc.</param>
        /// <param name="offset">See external doc.</param>
        public override void InternalWrite(SpellEntry<StringDBCReference> value, Span<byte> buffer, ref int offset)
        {
            //Type: SpellEntry Field: 1 Name: SpellId Type: Int32;
            ...
            //Type: SpellEntry Field: 79 Name: SpellName Type: LocalizedStringDBC;
            LocalizedStringDBC_StringDBCReference_AutoGeneratedTemplateSerializerStrategy.Instance.Write(value.SpellName, buffer, ref offset);
            //Type: SpellEntry Field: 81 Name: Rank Type: LocalizedStringDBC;
            LocalizedStringDBC_StringDBCReference_AutoGeneratedTemplateSerializerStrategy.Instance.Write(value.Rank, buffer, ref offset);
            //Type: SpellEntry Field: 83 Name: Description Type: LocalizedStringDBC;
            LocalizedStringDBC_StringDBCReference_AutoGeneratedTemplateSerializerStrategy.Instance.Write(value.Description, buffer, ref offset);
            //Type: SpellEntry Field: 85 Name: ToolTip Type: LocalizedStringDBC;
            LocalizedStringDBC_StringDBCReference_AutoGeneratedTemplateSerializerStrategy.Instance.Write(value.ToolTip, buffer, ref offset);
            //Type: SpellEntry Field: 87 Name: ManaCostPercentage Type: UInt32;
