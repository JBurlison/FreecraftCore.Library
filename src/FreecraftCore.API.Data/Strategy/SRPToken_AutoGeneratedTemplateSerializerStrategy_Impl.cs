...
namespace FreecraftCore
{
    ...
    public partial class SRPToken : IWireMessage<SRPToken>
    {
        public virtual Type SerializableType => typeof(SRPToken);
        public virtual SRPToken Read(Span<byte> buffer, ref int offset)
        {
            SRPToken_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public virtual void Write(SRPToken value, Span<byte> buffer, ref int offset)
        {
            SRPToken_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
