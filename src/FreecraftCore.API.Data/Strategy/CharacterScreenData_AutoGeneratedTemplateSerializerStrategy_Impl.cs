...
namespace FreecraftCore
{
    ...
    public partial class CharacterScreenData : IWireMessage<CharacterScreenData>
    {
        public virtual Type SerializableType => typeof(CharacterScreenData);
        public virtual CharacterScreenData Read(Span<byte> buffer, ref int offset)
        {
            CharacterScreenData_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public virtual void Write(CharacterScreenData value, Span<byte> buffer, ref int offset)
        {
            CharacterScreenData_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
