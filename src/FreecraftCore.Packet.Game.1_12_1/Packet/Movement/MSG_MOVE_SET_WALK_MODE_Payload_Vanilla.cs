...
namespace FreecraftCore
{
	...
	public sealed class MSG_MOVE_SET_WALK_MODE_Payload_Vanilla : GamePacketPayload, IPlayerMovementPayload<MovementInfo_Vanilla, MovementFlags_Vanilla, PackedGuid>
	{
		/// <summary>
		...
		public MSG_MOVE_SET_WALK_MODE_Payload_Vanilla([NotNull] MovementInfo_Vanilla moveInfo)
		{
		...
		/// <inheritdoc />
		public MSG_MOVE_SET_WALK_MODE_Payload_Vanilla([NotNull] PackedGuid movementGuid, [NotNull] MovementInfo_Vanilla moveInfo)
		{
			MovementGuid = movementGuid ?? throw new ArgumentNullException(nameof(movementGuid));
			MoveInfo = moveInfo ?? throw new ArgumentNullException(nameof(moveInfo));
		}

		protected MSG_MOVE_SET_WALK_MODE_Payload_Vanilla()
		{
